...
var SEED_COMPANIES = [
  {
    ...
    sector: "SaaS B2B",
    sectorPrecise: "SaaS Comptabilit\xE9 B2B",
    employeeCount: 520,
    fundingStage: "series_c",
    lastFundingAmount: 4e4,
    ...
    score: {
      ...
      flags: [
        ...
        { type: "republication", label: "Annonce AE republi\xE9e 4x", severity: "high" },
        { type: "funding", label: "S\xE9rie C il y a 5 mois", severity: "med" }
      ]
    },
    recommendation: "Pennylane traverse une fen\xEAtre courte de difficult\xE9 de sourcing : republication 4x de l'AE Mid-Market sur 60 jours, \xE9quipe interne RH de 3 personnes seulement, et arriv\xE9e r\xE9cente d'une VP Sales qui a d\xE9j\xE0 scal\xE9 un cabinet partner chez Aircall. Angle gagnant : proposer un mandat exclusif sur 2 postes Senior AE sous 7 jours.",
    mandate: {
      estimateMin: 92,
      estimateMax: 156,
      breakdown: [
    ...
    decisionMakers: [
      { fullName: "Arthur Waller", role: "ceo", titleExact: "CEO & Co-founder", linkedinUrl: "https://www.linkedin.com/in/arthurwaller/", isRecent: false, startedDaysAgo: 1825, angleApproach: "Arthur poste r\xE9guli\xE8rement sur la transition Mid-Market depuis sa s\xE9rie C. Hook : un retour terrain sur les profils AE qui r\xE9ussissent vs \xE9chouent en transition Solo\u2192Mid-Market chez les concurrents." },
      { fullName: "Marie Dupont", role: "vp_sales", titleExact: "VP Sales", linkedinUrl: "https://www.linkedin.com/in/marie-dupont/", isRecent: true, startedDaysAgo: 150, angleApproach: "Marie vient d'Aircall o\xF9 elle a scal\xE9 l'\xE9quipe AE de 8 \xE0 35 en 18 mois. Elle conna\xEEt les cabs sp\xE9. Approche : LinkedIn direct, parler chiffres et profils pr\xE9cis d\xE8s le 1er \xE9change." },
      { fullName: "Thomas Bernard", role: "head_ta", titleExact: "Head of Talent Acquisition", linkedinUrl: "https://www.linkedin.com/in/thomas-bernard/", isRecent: false, startedDaysAgo: 730, angleApproach: "Thomas a publi\xE9 les 6 annonces Sales lui-m\xEAme sur LinkedIn. Il porte la charge sourcing seul. Hook empathique : reconna\xEEtre la pression et proposer un soulagement imm\xE9diat sur 2-3 postes prioritaires." },
      { fullName: "Sophie Lambert", role: "head_of_sales", titleExact: "Head of Mid-Market Sales", linkedinUrl: "https://www.linkedin.com/in/sophie-lambert/", isRecent: true, startedDaysAgo: 240, angleApproach: "Sophie est l'utilisatrice finale des recrutements. Approche : la rencontrer en parall\xE8le de Marie pour valider le profil 'ideal AE' \u2014 beaucoup de cabs ne le font jamais et ratent le brief." }
    ],
    timeline: [
      { daysAgo: 240, eventType: "leadership_change", description: "Sophie Lambert promue Head of Mid-Market Sales" },
      { daysAgo: 150, eventType: "funding", description: "Lev\xE9e S\xE9rie C de 40M\u20AC (lead Sequoia)" },
      { daysAgo: 150, eventType: "leadership_change", description: "Marie Dupont rejoint en VP Sales (ex-Aircall)" },
      { daysAgo: 90, eventType: "job_published", description: "Premi\xE8re publication Account Executive Mid-Market" },
  ...
  },
  {
    ...
    score: {
      ...
      flags: [
        ...
        { type: "republication", label: "AE EMEA republi\xE9e 2x", severity: "med" },
        { type: "leadership", label: "Nouveau CRO il y a 3 mois", severity: "high" }
      ]
    },
    recommendation: "Spendesk a r\xE9organis\xE9 son go-to-market Enterprise sur Q1 2026 et republie deux fois l'AE Enterprise EMEA. Le nouveau CRO arrive d'Algolia avec un track record de cabinet-friendly hiring. Angle gagnant : proposer un mandat cibl\xE9 sur le profil 'AE Enterprise senior multi-pays', le plus dur \xE0 sourcer en interne.",
    mandate: {
      estimateMin: 78,
      estimateMax: 138,
      breakdown: [
        { role: "2 postes AE Enterprise EMEA", salary: 125, rate: 0.24, mandate: 6e4 },
        { role: "1 poste Sales Manager DACH", salary: 140, rate: 0.25, mandate: 35e3 },
        { role: "1 poste Sales Engineer Senior", salary: 100, rate: 0.22, mandate: 22e3 }
      ]
    },
    jobs: [
    ...
    decisionMakers: [
      { fullName: "Rodolphe Ardant", role: "ceo", titleExact: "CEO & Co-founder", linkedinUrl: "https://www.linkedin.com/in/rodolpheardant/", isRecent: false, startedDaysAgo: 3650, angleApproach: "Rodolphe parle ouvertement de sa difficult\xE9 \xE0 recruter les profils Enterprise. Hook : retour structur\xE9 sur 3 candidats AE Enterprise plac\xE9s chez Pigment ou Aircall ces 6 derniers mois." },
      { fullName: "Nicolas Martin", role: "vp_sales", titleExact: "CRO", linkedinUrl: "https://www.linkedin.com/in/nicolas-martin/", isRecent: true, startedDaysAgo: 90, angleApproach: "Nicolas vient d'Algolia o\xF9 il a travaill\xE9 avec 2 cabinets externes sp\xE9cialis\xE9s. Approche : message LinkedIn franc, mentionner un candidat sp\xE9cifique disponible imm\xE9diatement, pas de pitch g\xE9n\xE9rique." },
      { fullName: "L\xE9a Rousseau", role: "head_ta", titleExact: "VP Talent", linkedinUrl: "https://www.linkedin.com/in/lea-rousseau/", isRecent: false, startedDaysAgo: 540, angleApproach: "L\xE9a pilote 4 recruteurs internes d\xE9bord\xE9s sur Tech. Sales est son angle mort. Hook : proposer un audit gratuit du funnel AE Enterprise avant tout commercial \u2014 elle dira oui en 48h." },
      { fullName: "Pierre Caron", role: "head_of_sales", titleExact: "Head of Enterprise Sales EMEA", linkedinUrl: "https://www.linkedin.com/in/pierre-caron/", isRecent: true, startedDaysAgo: 120, angleApproach: "Pierre est le manager direct des AE recherch\xE9s. Il a publi\xE9 sur LinkedIn ses crit\xE8res 'profil id\xE9al'. Approche : reformuler son brief en interview structur\xE9e, c'est ton ouverture." }
    ],
    timeline: [
      { daysAgo: 210, eventType: "funding", description: "Lev\xE9e S\xE9rie C de 100M\u20AC (lead Index Ventures)" },
      ...
      { daysAgo: 60, eventType: "other", description: "Annonce de la strat\xE9gie Mid-Market DACH" },
  ...
  },
  {
    ...
    lastFundingAmount: 12e4,
    lastFundingDate: "2021-06-01",
    ceoName: "Olivier Pailh\xE8s",
    ...
    score: {
      ...
      flags: [
        ...
        { type: "republication", label: "AE EMEA republi\xE9e 3x", severity: "high" },
        { type: "leadership", label: "Nouvelle SVP Sales il y a 2 mois", severity: "high" }
      ]
    },
    recommendation: "Aircall a connu un turnover Sales important sur Q4 2025 et reconstruit son \xE9quipe AE EMEA avec 5 ouvertures simultan\xE9es en 6 semaines. La nouvelle SVP Sales arrive de Salesforce et privil\xE9gie les cabinets boutiques. Angle gagnant : un mandat d'urgence sur 2 postes AE EMEA avec garantie 90 jours.",
    mandate: {
      estimateMin: 64,
      estimateMax: 112,
      breakdown: [
    ...
    decisionMakers: [
      { fullName: "Olivier Pailh\xE8s", role: "ceo", titleExact: "CEO & Co-founder", linkedinUrl: "https://www.linkedin.com/in/olivierpailhes/", isRecent: false, startedDaysAgo: 4380, angleApproach: "Olivier est sensible aux signaux de stabilit\xE9 d'\xE9quipe apr\xE8s le turnover Q4. Hook : un point de vue sur la r\xE9tention AE post-onboarding plut\xF4t qu'un pitch direct." },
      { fullName: "Caroline Petit", role: "vp_sales", titleExact: "SVP Sales EMEA", linkedinUrl: "https://www.linkedin.com/in/caroline-petit/", isRecent: true, startedDaysAgo: 60, angleApproach: "Caroline vient de Salesforce et a d\xE9j\xE0 boss\xE9 avec deux cabs sp\xE9 pendant son passage. Approche : message LinkedIn court avec 1 candidat pr\xE9cis, garantie 90j explicite." },
      { fullName: "Mathieu Roche", role: "head_ta", titleExact: "Director of Talent", linkedinUrl: "https://www.linkedin.com/in/mathieu-roche/", isRecent: false, startedDaysAgo: 1095, angleApproach: "Mathieu conna\xEEt tous les cabs de la place. Le diff\xE9renciant n'est pas le pitch mais la qualit\xE9 du shortlist. Approche : envoyer 2 profils cibl\xE9s directement, sans pitch." },
      { fullName: "Julien Garnier", role: "head_of_sales", titleExact: "Head of Sales France", linkedinUrl: "https://www.linkedin.com/in/julien-garnier/", isRecent: true, startedDaysAgo: 180, angleApproach: "Julien recrute pour son \xE9quipe directement. Il pr\xE9f\xE8re les cabs qui connaissent le march\xE9 telco/SaaS. Hook : r\xE9f\xE9rences concr\xE8tes de placements chez Ringover, Diabolocom." }
    ],
    timeline: [
      { daysAgo: 270, eventType: "other", description: "Restructuration \xE9quipe Sales annonc\xE9e en interne" },
      { daysAgo: 180, eventType: "leadership_change", description: "Julien Garnier promu Head of Sales France" },
      { daysAgo: 120, eventType: "team_growth", description: "Vague de d\xE9parts Sales (>10 AE EMEA)" },
      { daysAgo: 60, eventType: "leadership_change", description: "Caroline Petit rejoint en SVP Sales EMEA (ex-Salesforce)" },
      { daysAgo: 42, eventType: "job_published", description: "Ouverture simultan\xE9e de 5 postes AE EMEA" },
      { daysAgo: 21, eventType: "job_republished", description: "Republication AE EMEA et AE Mid-Market" },
      { daysAgo: 0, eventType: "team_growth", description: "5 postes Sales ouverts, \xE9quipe \xE0 reconstruire" }
    ]
  }
];
...
async function seedReferenceCompanies() {
  const result = {
    companiesUpserted: 0,
    jobsUpserted: 0,
    scoresUpserted: 0,
  ...
  for (const seed of SEED_COMPANIES) {
    ...
    await db.delete(companyScores).where(eq8(companyScores.companyId, companyId));
    ...
    await db.delete(decisionMakers).where(eq8(decisionMakers.companyId, companyId));
    for (const dm of seed.decisionMakers) {
      await db.insert(decisionMakers).values({
        ...
        angleGeneratedAt: /* @__PURE__ */ new Date()
      });
      result.decisionMakersUpserted += 1;
    }
    await db.delete(companyRecommendations).where(eq8(companyRecommendations.companyId, companyId));
    ...
    await db.delete(mandateEstimates).where(eq8(mandateEstimates.companyId, companyId));
    ...
    await db.delete(companyTimelineEvents).where(eq8(companyTimelineEvents.companyId, companyId));
    let order = 0;
...
router9.post("/seed-reference-companies", async (req, res) => {
  if (!authorize(req, res)) return;
  try {
